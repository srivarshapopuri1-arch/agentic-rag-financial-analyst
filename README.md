...
I wrote a more detailed walkthrough of the document-processing, retrieval, agent, calculator, and citation flow in [`docs/PROJECT_GUIDE.md`](docs/PROJECT_GUIDE.md).
